...
function FinancialCard({
  ...
  return (
    <Card
      className={`${bg} h-44 flex flex-col justify-between transition hover:shadow-md p-4 sm:p-6`}
    >
      <Card.Header>
      ...
      {/* Chart */}
      <Card.Body className="mx-auto w-[50%] h-14">
      ...
      <Card.Footer>
        ...
        <span
          className={`flex items-cneter justify-center gap-2 text-sm font-semibold ${percentColor}`}
        >
