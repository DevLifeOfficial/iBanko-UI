...
export default function SendMoneyTo() {
  ...
  return (
    <div className="w-full bg-white rounded-2xl p-4 sm:p-6 h-35 sm:h-40 shadow-sm font-sans">
      <div className="flex items-center justify-between mb-4 px-2 sm:px-4">
        <h2 className="text-2xl font-bold text-black">Send Money To</h2>
        <button
          type="button"
          title="More options"
          className="group text-sm p-2 font-medium text-black transition rounded-full hover:bg-gray-400 cursor-pointer"
        >
